...
const storyChapters = [
  ...
  {
    year: "Today",
    kicker: "Kadugannawa to Qatar & Beyond",
    title: "ARCO Trading & Marketing",
    body: "Through international business activities and ARCO Trading & Marketing in Qatar, NBI HOLDING introduces authentic Sri Lankan products to hotels, restaurants, cafés, supermarkets, and global markets.",
